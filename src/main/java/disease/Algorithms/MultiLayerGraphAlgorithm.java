 ...
 */
public abstract class MultiLayerGraphAlgorithm  {
     ...
     */
    public MultiLayerGraphAlgorithm(IMultiRelationGraph G, Map<Long,Long> idToClass, MatrixMatrix toInitialize) {
    ...
    protected abstract void execute(IMultiRelationGraph G, Map<Long,Long> idToClass, MatrixMatrix toInitialize);
